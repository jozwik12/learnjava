    ...
    public static double mean(String town, String strng) {
        ...
        for (String s : strng.split("\n")) {
            if (s.contains(town)) {
                ...
                Arrays.stream(s.split("\\D{4,}")).forEach(System.out::println);   //mapToDouble(Double::parseDouble).toArray();
//                double mean = 0;
...
//        System.out.println(mean("Rome", data1));
//        System.out.println(variance("Rome", data1));
    }
}
